...
void UHandlersScanner::GenerateScriptAssetPaths()
{
	...
	ClassContent.Append("class PROJECTCORERUNTIME_API UAssetPaths : public UObject\n");
	ClassContent.Append("{\n");
	...
	FString FilePath = FPaths::ProjectDir() / TEXT("Source/ProjectCoreRuntime/ScriptsGeneration/AssetPaths.h");
...
void UHandlersScanner::GenerateScriptIds()
{
    ...
    ClassContent.Append("class PROJECTCORERUNTIME_API Ids\n");
    ClassContent.Append("{\n");
    ClassContent.Append("public:\n");
    ...
    FString FilePath = FPaths::ProjectDir() / TEXT("Source/ProjectCoreRuntime/ScriptsGeneration/Ids.h");
    FFileHelper::SaveStringToFile(ClassContent, *FilePath);
}
